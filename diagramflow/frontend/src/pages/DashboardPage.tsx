        ...
        <div className="headerRight">
          <div className="headerButtons">
            {['Home', 'About', 'Help'].map((label) => (
              <div key={label} className="button" onClick={() => alert("This feature is not implemented yet")}>
          ...
          <div className="genericAvatar">
            <img src={ExampleAvatar} alt="User Avatar" className="avatarImage" />
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div className="helloUsername">
            <span className="helloUsernameTxtContainer">
              <span>Welcome </span>
              <span className="draw">&lt;username&gt;!</span>
            </span>
          </div>
